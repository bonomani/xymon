...
if [[ "${goal}" == "ref" ]]; then
  ...
  baseline_build_tool="${baseline_root%%__*}"
  baseline_runtime_os="${baseline_root#*__}"
  ...
  if [[ -z "${legacy_hostname_config}" ]]; then
    legacy_hostname_config="docs/refs/ref/${baseline_build_tool}/${baseline_runtime_os}/${platform_id}/server/${artifact_arch}/var/lib/xymon/server/etc/xymonserver.cfg"
  fi
  if [[ -z "${baseline_prefix}" ]]; then
    baseline_prefix="docs/refs/ref/${baseline_build_tool}/${baseline_runtime_os}/${platform_id}/${variant}/${artifact_arch}"
  fi
