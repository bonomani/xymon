...
- **Reproducing CI**:
  ...
  2. Add `--use-ci-configure --preset <name> --variant server|client [--localclient ON|OFF]` to run `scripts/ci/cmake-configure.sh`/`cmake-build.sh` instead of the local configure logic.
